"""
    struct HomSpace{S<:ElementarySpace, P1<:ProductSpace{S}, P2<:ProductSpace{S}}
        codomain::P1
        domain::P2
    end
...
Base.adjoint(W::HomSpace{<:ElementarySpace}) = HomSpace(W.domain, W.codomain)
...
"""
blocksectors(W::HomSpace) = intersect(blocksectors(codomain(W)), blocksectors(domain(W)))
