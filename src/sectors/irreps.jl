...
dim(a::AbelianIrrep) = 1
sqrtdim(a::AbelianIrrep) = 1
isqrtdim(a::AbelianIrrep) = 1

# not necessary 
# @inline ⊗(a::I, b::I, c::I, rest::Vararg{I}) where {I<:AbelianIrrep} = a ⊗ first(⊗(b, c, rest...))
